...
// A função de busca e os tipos não mudam, apenas o visual
...
export default async function Header() {
  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-30">
      ...
      <div className="bg-g1-red text-white">
      ...
      <div className="border-b border-neutral-200">
        <div className="container mx-auto px-4 flex justify-between items-center py-4">
          <Link href="/" className="text-4xl font-black text-g1-red tracking-tighter">
            Oeste Paraná
          </Link>
        ...
        <div className="container mx-auto px-4">
          <ul className="flex items-center space-x-6">
            {categorias.map((categoria) => (
              <li key={categoria.id}>
                <Link href={`/categoria/${categoria.slug}`} className="text-neutral-800 font-bold py-3 block border-b-4 border-transparent hover:border-g1-red transition-colors">
                  {categoria.nome}
                </Link>
              </li>
            ))}
