      ...
      <div className="p-5 flex flex-col flex-grow">
        {categoria && (
          ...
          <Link 
            ...
            className="font-heading text-xs font-bold uppercase bg-primary text-white px-3 py-1 rounded-full self-start hover:bg-primary-dark transition-colors duration-300 mb-3 inline-block"
          >
            {categoria.nome}
          </Link>
        )}
